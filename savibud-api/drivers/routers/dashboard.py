...
async def get_dashboard_summary(
    ...
    total_budget = budget_repo.sum_amount(current_user.id,period_start, period_end)
    total_budget_spent = budget_repo.sum_amount_spent(current_user.id,period_start, period_end)
    upcoming_bills = budget_repo.remaining_bills(current_user.id,period_start, period_end)
